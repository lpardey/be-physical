...
def test_get_annotations(user_info: UserInfo, api_client_authenticated: APIClient) -> None:
...
@pytest.mark.django_db
def test_get_annotations_no_auth(api_client: APIClient) -> None:
...
@pytest.mark.django_db
def test_get_annotations_404(api_client_authenticated: APIClient) -> None:
