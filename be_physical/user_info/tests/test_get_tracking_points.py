...
def test_get_tracking_points_success(api_client_authenticated: APIClient, user_info_fixture: UserInfo):
...
@pytest.mark.django_db
class TestGetTrackingPointsIncorrectHTTPMethods(GenericTestIncorrectHTTPMethods):
    VIEW_NAME = GET_TRACKING_POINTS_VIEW_NAME
    ALLOWED_METHODS = ["get"]
